  ...
  <div id="home-page" class="full-height p-4">
          ...
          <div class="row pb-5">
            <div class="col-lg-6 pt-4 my-auto">
              <div class="text-center text-light mb-3 d-block d-lg-none">
                ...
                <h3>Log Your Wendler And Hatch Cycles</h3>
              </div>
              <img id="iphone-img" src="../assets/bn_home.png" class="img-fluid">
            </div>
            ...
            <div class="col-lg-6 pt-4 my-auto">
              ...
              <div class="border p-3 p-md-5 bg-dark text-light rounded shadow">
                <!-- <h2>Download For Free</h2> -->
                <div id="available" class="p-2">
                  <h3 class="text-center mb-2 mt-3 text-light">
                    Available Soon On
                  </h3>
                  <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg">
            ...
            <h5 class="ml-md-4 mr-md-4">
              ...
              Know exactly the cycle 5/5/5, 3/3/3, 5/3/1, or Deload to continue with in the next session.
            </h5>
          </div>
          <div class="col-lg">
            <!-- Icon made by Freepik perfect from www.flaticon.com -->
            ...
            <h5 class="ml-md-4 mr-md-4">
              The App will automatically calculate the weight plates to load for you!
              During your workout sessions, have the peace of mind that plates
      ...
      <div id="about" class="bg-light p-3 p-md-5">
        <div class="row">
          <div class="col-lg">
            <!-- Icon made by Freepik perfect from www.flaticon.com -->
            <img src="../assets/new_hatch_cycle.png" height="320" class="m-4">
            <h5 class="ml-md-4 mr-md-4">
              Start a new Hatch Squat program by setting your One Rep Maxes.
              Preview the Hatch Squat 12 week sessions for planning your
              training schedule.
            </h5>
          </div>
          <div class="col-lg">
            <!-- Icon made by Freepik perfect from www.flaticon.com -->
            <img src="../assets/bn_home_hatch_list.png" height="320" class="m-4">
            <h5 class="ml-md-4 mr-md-4">
              Use the app to track your Hatch Squat workout sessions.
              Know exactly where you are in the 12 week Hatch Squat program.
            </h5>
          </div>
          <div class="col-lg">
            <!-- Icon made by Freepik perfect from www.flaticon.com -->
            <img src="../assets/lbv_hatch.png" height="320" class="m-4">
            <h5 class="ml-md-4 mr-md-4">
      ...
      <div id="contact" class="p-4">
        <div class="row justify-content-center mt-3 mb-3">
          ...
          <div v-if="show_contact == true" class="col-lg-4 text-light">
            <h2>Have Any Questions?</h2>
            <p>Contact us by filling out the information below</p>

            <div v-if="contact_notice != ''" class="alert alert-warning text-light">
